...
This repository holds the published site: a static web app (Svelte, DuckDB-WASM) and the data it reads. It is written by the publish step of the Provincial Elections Dataset (PED) pipeline; nothing is edited here by hand. Build `20260923T111937Z`, pipeline commit `c2b5fe4`, built 2026-09-23T11:19:37Z.
...
| `candidates.parquet` | 75,278 | pedid, prabbr, eyear, cluster_id, name, name_key, person_key, link_basis, party_raw, family, family2, votes_first, votes_final, votes_final_source, share_first, share_final, rank_first, rank_final, elected, quality, slug |
| `seats.parquet` | 22,802 | pedid, prabbr, eyear, cluster_id, seat_index, family, family2 |
| `parties.parquet` | 299 | family, label_en, label_fr, colour_light, colour_dark, pattern, sort_order, n_rows, n_seats |
| `party_labels.parquet` | 913 | prabbr, party_raw, family, family2, first_eyear, last_eyear, n |
...
| `search_index.parquet` | 104,706 | type, prabbr, display_en, display_fr, key_norm, route |
...
| `lineages.parquet` | 2,098 | lineage_id, prabbr, first_eyear, last_eyear, n_contests, n_elections, n_branches_max, names_en, names_fr, lineage_basis, has_floterial, n_eras, n_polygons |
...
Taylor, Zack. *Atlas of Canadian Elections: provincial elections in Canada since 1867.* Build 20260923T111937Z. Western University.
