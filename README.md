...
This repository holds the published site: a static web app (Svelte, DuckDB-WASM) and the data it reads. It is written by the publish step of the Provincial Elections Dataset (PED) pipeline; nothing is edited here by hand. Build `20260924T201924Z`, pipeline commit `6a9c2c2`, built 2026-09-24T20:19:24Z.
...
| `candidates.parquet` | 75,159 | pedid, prabbr, eyear, cluster_id, name, name_key, person_key, link_basis, party_raw, party_source, family, family2, votes_first, votes_final, votes_final_source, share_first, share_final, rank_first, rank_final, elected, quality, slug |
| `seats.parquet` | 22,855 | pedid, prabbr, eyear, cluster_id, seat_index, family, family2 |
...
| `search_index.parquet` | 104,703 | type, prabbr, display_en, display_fr, key_norm, route |
...
| `source_use.parquet` | 2,076 | prabbr, eyear, field, src_abbr, dq, n |
...
Taylor, Zack. *Atlas of Canadian Elections: provincial elections in Canada since 1867.* Build 20260924T201924Z. Western University.
