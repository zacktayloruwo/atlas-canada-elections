...
This repository holds the published site: a static web app (Svelte, DuckDB-WASM) and the data it reads. It is written by the publish step of the Provincial Elections Dataset (PED) pipeline; nothing is edited here by hand. Build `20260924T163450Z`, pipeline commit `81e65c8`, built 2026-09-24T16:34:50Z.
...
| `search_index.parquet` | 104,718 | type, prabbr, display_en, display_fr, key_norm, route |
...
| `geo_join.parquet` | 19,342 | pedid, prabbr, eyear, geo_id, geo_role, join_basis |
| `geo_orphans.parquet` | 1,926 | side, prabbr, eyear, ro_year, name, id, reason |
...
| `lineages.parquet` | 2,102 | lineage_id, prabbr, first_eyear, last_eyear, n_contests, n_elections, n_branches_max, names_en, names_fr, lineage_basis, has_floterial, n_eras, n_polygons |
| `source_use.parquet` | 2,080 | prabbr, eyear, field, src_abbr, dq, n |
...
Taylor, Zack. *Atlas of Canadian Elections: provincial elections in Canada since 1867.* Build 20260924T163450Z. Western University.
